<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="header.ascx.cs" Inherits="LInq_Payroll.usercontrols.header" %>
<!-- Navigation -->
        ...
        <li class="mega-dropdown">
          ...
          <ul class="dropdown-menu mega-dropdown-menu animated bounceInDown">
            ...
            <li class="col-sm-12 m-t-40 demo-box">
               <div class="row">
                  <div class="col-sm-2"><div class="white-box text-center bg-purple"><a href="index.html" target="_blank" class="text-white"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i><br/>Demo 1</a></div></div>
