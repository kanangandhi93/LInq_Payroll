<%@ Page Title="" Language="C#" MasterPageFile="~/master.Master" AutoEventWireup="true" CodeBehind="city_manage.aspx.cs" Inherits="LInq_Payroll.city_manage" %>
                        ...
                        <div class="col-sm-12 col-xs-12">
                            <div role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" class="form-control" ID="txtCountryName" onkeydown="return isAlpha(event.keyCode);" placeholder="Enter Country Name" required />
                                </div>
